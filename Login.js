        ...
        return (
            ...
            <View style={styles.container}>
                <KeyboardAwareScrollView>
                    ...
                    <Text style={{textAlign:'center',marginRight:40 ,width:'100%',color :'grey',fontFamily:'Poppins-Regular',fontSize: 16,marginTop:12}} >

                       Please Log In to your account to continue with Anytimedoc.
                    </Text>
