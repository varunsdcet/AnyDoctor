        ...
        return (
            <SafeAreaView>
                <View style={styles.container}>
                        ...
                        <Image style = {{width :300 ,height: 140,alignSelf:'center',marginTop:'20%',resizeMode: 'contain'}}
                               source={require('./logo.png')}/>



                        <Text style={{textAlign:'center',width:'100%',color :'black',fontFamily:'Konnect-Regular',fontSize: 20,marginTop:40,alignSelf:'center'}} >
                        ...
                        <Text style={{textAlign:'center',width:'100%',color :'#c6c6c6',fontFamily:'Konnect-Regular',fontSize: 16,marginTop:8,alignSelf:'center' }} >

                           Introducing Loreum,with more than 6 thousand recipes and amazing features loreum is your best choice to make any cook great.
                        </Text>
                        ...
                        <Button
                            style={{padding:12,marginTop:45,fontSize: 16,borderWidth:1,borderColor:'#c6c6c6', color: '#c6c6c6',backgroundColor:'transparent',marginLeft:'5%',width:'90%',height:45,fontFamily:'Konnect-Regular',borderRadius:4}}
                        ...
                        <Button
                            style={{padding:12,marginTop:30,fontSize: 16,borderWidth:1,borderColor:'#c6c6c6', color: '#c6c6c6',backgroundColor:'transparent',marginLeft:'5%',width:'90%',height:45,fontFamily:'Konnect-Regular',borderRadius:4}}
                            styleDisabled={{color: 'red'}}
                            onPress={() => this.login()}>
                            SIGN UP
                        </Button>
