                ...
                <View style={styles.container}>
                    <KeyboardAwareScrollView>
                        ...
                        <ImageBackground source={require('./background.png')}style={{width: '100%', height: '100%'}}>
                            ...
                            <Text style={{marginLeft:20,textAlign:'left',width:'100%',color :'black',fontFamily:'Konnect-Medium',fontSize: 30,marginTop:40}} >
                            ...
                            <Text style= {{alignSelf:'flex-end',marginRight:20,fontSize:16,fontFamily:'Konnect-Regular',padding:11,color:'#800000',marginTop:20}} >
                                RESEND
                            </Text>
